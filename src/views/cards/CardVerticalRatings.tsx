        ...
        <Card>
            ...
            <CardContent>
                ...
                <Typography variant='body2' sx={{ marginBottom: 3.25 }}>
                    If you are looking for a new way to promote your business that won’t cost you more money, maybe
                    printing is one of the options you won’t resist.
                </Typography>
                <Typography variant='body2'>
                    Printing is a widely use process in making printed materials that are used for advertising. It
